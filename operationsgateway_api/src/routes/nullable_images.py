...
@router.get(
    "/images/nullable/{record_id}/{channel_name}",
    summary="Get nullable image",
...
async def get_full_image(
    ...
    if colourmap_name is None:
        colourmap_name = await NullableImage.get_preferred_colourmap(access_token)

    bytes_io = await NullableImage.get_image(record_id, channel_name, colourmap_name)
